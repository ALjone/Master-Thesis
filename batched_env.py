...
class BlackBox():
    def __init__(self, resolution = 40, domain = [0, 10], batch_size = 128, num_init_points = 2, T = 60, kernels = None, dims = 3, use_GP = True, GP_learning_rate = 0.1, GP_training_iters = 200, approximate = False):
